...
export default function ModelDetail({ params }: ModelDetailProps) {
  ...
  const translations = {
    ...
    fr: {
      ...
      powerOutput: 'Puissance totale',
      safetyRating: 'Sécurité Euro NCAP',
      sourceEuroNCAP: 'Source : Euro NCAP',
      electricPerformance: 'Performances électriques',
      enginePerformance: 'Moteur & Performances',
      comfortSpace: 'Confort & Dimensions',
      general: 'Général',
      electricRangeLabel: 'Autonomie électrique',
      batteryCapacityLabel: 'Capacité de batterie',
      acChargeTime: 'Temps de charge AC',
      dcChargeTime: 'Temps de charge DC',
      acCharging: 'Recharge AC',
      dcCharging: 'Recharge rapide DC',
      batteryType: 'Type de batterie',
      power: 'Puissance',
      engine: 'Moteur thermique',
      fuelConsumption: 'Consommation mixte',
      co2Emission: 'Émissions de CO₂',
      segment: 'Segment',
      trunkVolume: 'Volume du coffre',
      seats: 'Places assises',
      warranty: 'Garantie',
      countryAvailability: 'Disponibilité',
      brand: 'Marque',
      model: 'Modèle',
      year: 'Année',
      price: 'Prix',
      estimatedEU: 'Est. UE',
      battery: 'BATTERIE',
      batteryDescription: 'Capacité énergétique en kilowattheures',
      range: 'AUTONOMIE (KM)',
      rangeDescription: 'Autonomie selon le cycle officiel mixte WLTP',
      onboardChargerAC: 'CHARGEUR EMBARQUÉ (AC)',
      onboardChargerACDescription: 'Puissance maximale de charge en courant alternatif',
      maxChargingPowerDC: 'PUISSANCE MAX (DC)',
      maxChargingPowerDCDescription: 'Puissance maximale sur borne de recharge rapide',
      chargingSocketAC: 'CONNECTEUR AC',
      chargingSocketACDescription: 'Prise embarquée pour recharge standard (Type 2)',
      fastChargingDC: 'CHARGE RAPIDE (DC)',
      fastChargingDCDescription: 'Connecteur haute puissance pour autoroute (CCS/CHAdeMO)',
      notSupported: 'Non supporté',
      canBeUpgradedTo11kW: 'Optionnel jusqu’à 11 kW'
    },
    es: {
      backToModels: 'Volver a los modelos',
      lightTheme: 'Tema claro',
      darkTheme: 'Tema oscuro',
      startingPrice: 'Precio de partida',
      electricRange: 'Autonomía eléctrica',
      batteryCapacity: 'Capacidad de batería',
      powerOutput: 'Potencia total',
      safetyRating: 'Seguridad Euro NCAP',
      sourceEuroNCAP: 'Fuente: Euro NCAP',
      electricPerformance: 'Rendimiento eléctrico',
      enginePerformance: 'Motor y prestaciones',
      comfortSpace: 'Confort y dimensiones',
      general: 'General',
      electricRangeLabel: 'Autonomía eléctrica',
      batteryCapacityLabel: 'Capacidad de batería',
      acChargeTime: 'Tiempo de carga AC',
      dcChargeTime: 'Tiempo de carga DC',
      acCharging: 'Recarga AC',
      dcCharging: 'Recarga rápida DC',
      batteryType: 'Tipo de batería',
      power: 'Potencia',
      engine: 'Motor térmico',
      fuelConsumption: 'Consumo homologado',
      co2Emission: 'Emisiones de CO₂',
      segment: 'Segmento',
      trunkVolume: 'Volumen del maletero',
      seats: 'Plazas',
      warranty: 'Garantía',
      countryAvailability: 'Disponibilidad',
      brand: 'Marca',
      model: 'Modelo',
      year: 'Año',
      price: 'Precio',
      estimatedEU: 'Est. UE',
      battery: 'BATERÍA',
      batteryDescription: 'Capacidad neta/bruta en kilovatios hora',
      range: 'AUTONOMÍA (KM)',
      rangeDescription: 'Autonomía en kilómetros según ciclo oficial WLTP',
      onboardChargerAC: 'CARGADOR DE A BORDO (AC)',
      onboardChargerACDescription: 'Potencia máxima de carga en corriente alterna',
      maxChargingPowerDC: 'POTENCIA MÁXIMA (DC)',
      maxChargingPowerDCDescription: 'Potencia máxima en puntos de carga rápida',
      chargingSocketAC: 'TOMA DE CARGA AC',
      chargingSocketACDescription: 'Conector del vehículo para carga convencional (Tipo 2)',
      fastChargingDC: 'CARGA RÁPIDA (DC)',
      fastChargingDCDescription: 'Conector de carga rápida para viajes (CCS/CHAdeMO)',
      notSupported: 'No disponible',
      canBeUpgradedTo11kW: 'Ampliable a 11 kW opcional'
    }
  }

  const t = isClient ? (translations[selectedLanguage as keyof typeof translations] || translations['en']) : translations['en']
