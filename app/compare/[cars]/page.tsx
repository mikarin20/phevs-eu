...
export default function ComparePage({ params }: ComparePageProps) {
  ...
  const translations = {
    en: {
      ...
      legendDescription: 'Highlighted cells indicate the best value in each category. Lower values are better for consumption and emissions. Higher values are better for range, power, and capacity.',
    ...
    tr: {
      ...
      legendDescription: 'Vurgulanan hücreler her kategorideki en iyi değeri gösterir. Tüketim ve emisyon için düşük değerler daha iyidir. Menzil, güç ve kapasite için yüksek değerler daha iyidir.',
    ...
    de: {
      ...
      legendDescription: 'Hervorgehobene Zellen zeigen den besten Wert in jeder Kategorie. Niedrigere Werte sind besser für Verbrauch und Emissionen. Höhere Werte sind besser für Reichweite, Leistung und Kapazität.',
    ...
    pl: {
      ...
      legendDescription: 'Podświetlone komórki wskazują najlepszą wartość w każdej kategorii. Niższe wartości są lepsze dla zużycia i emisji. Wyższe wartości są lepsze dla zasięgu, mocy i pojemności.',
